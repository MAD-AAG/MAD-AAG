...
window.MEETINGS = [
  ...
  /* ----- 2026 MEETING (UPCOMING) ----- */
  {
    ...
    programLink: "",
    keynote:     "",
    description: "The Middle Atlantic Division Annual Meeting brings together geographers from across Maryland, Northern Virginia, and Washington, DC for a full day of paper sessions, keynote lectures, and collegial exchange. We welcome contributions from all geographic subdisciplines and career stages, including students from high school to graduate level.",
    schedule: [
